      ...
      <nav class="navbar navbar-default">
        ...
        <div class="col-md-5 col-sm-10 col-xs-10">
          <ul class="nav navbar-nav navbar-right menu">
             <li style="display: none;" id="search_X"><a style="cursor: pointer;" onclick="abrir_search()"><span class="glyphicon glyphicon-remove menu-icon"></span></a></li>
            <li>
              <div style="display: none;" id="search-bar">
                <div class="container-4">
                  <form action="search.php" method="GET">
                    <input type="search" name="q" id="search" placeholder="O que você deseja?" />
                    <button class="icon"><span class="glyphicon glyphicon-search menu-icon"></span></button>
                  </form>
                </div>
              </div>
            </li>
            <li id="search_opener"><a style="cursor: pointer;" onclick="abrir_search()"><span class="glyphicon glyphicon-search menu-icon"></span></a></li>
            <li><a style="cursor: pointer;" onclick="abrir_submenu()"><span class="glyphicon glyphicon-user menu menu-icon"></span></a>
              <div style="display: none;" id="submenu_over">
                <ul class="submenu_logado">
                  <?php 
                  $nome = $_SESSION['usuario'];
                  ?>
                  <li class="submenu_logado_title">Olá, <?php echo $nome ?></li>
                  <li class="submenu_logado_item"><a href="minha_conta.php"><span class="glyphicon glyphicon-menu-right"></span>  Minha Conta</a></li>
                  <li class="submenu_logado_item_last"><a href="sair_login.php"><span class="glyphicon glyphicon-log-out"></span>  Sair</a></li>
                </ul>
              </div>
            </li>
