    ...
    <div class="container">
        <div class="row msa">
            ...
            <div class="col-md-6 msa-dois">
                ...
                <p>Ja teve aquela vontade de ter uma camiseta exclusiva só sua? Agora você pode! Através do "monte a sua arte" você pode enviar um design e nós fazemos a impressão em uma camiseta, pôster, quadro ou caneca, ser geek nunca foi tão fácil!</p>
                <div class="container"><a href="msa.php"><button id="btn-um">MONTAR</button></a></div>
            </div>
        </div>
    </div>
