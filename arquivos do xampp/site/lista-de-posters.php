...
<?php
    if($resultado_id){
        ...
        while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
		   ...
		   echo "<li><img src='admin/img/produtos/".$registro['foto1']."'><br><span class='prod-name'>".$registro['nome']."</span><br><span class='price' name='preco'>".$registro['preco']."</span><br><a href='produto.php?prod=".$registro['idprodutos']."'><button type='submit' class='btn-list btn btn-success'>Comprar</button></a></li>";
