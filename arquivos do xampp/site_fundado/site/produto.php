				...
				<form method='post' action='addcar.php?prod=$idprod' id='formprod'>
					...
					<div class='tamanho-produto'>
							<div class='radio-group'>
								<input type='radio' id='option-one' name='selector' value='PP'><label for='option-one'>PP</label>
								<input type='radio' id='option-two' name='selector' value='P'><label for='option-two'>P</label>
								<input type='radio' checked id='option-three' value='M' name='selector'><label for='option-three'>M</label>
								<input type='radio' id='option-four' name='selector' value='G'><label for='option-four'>G</label>
								<input type='radio' id='option-five' name='selector' value='GG'><label for='option-five'>GG</label>
 							</div>				
					</div>
